...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" dir="ltr">
  <head>
    ...
    <link href="{{url('index/css')}}/forum_1.css" media="screen" rel="stylesheet" type="text/css" />
    <script src="{{url('index/js')}}/application_1.js" type="text/javascript"></script>
    <script>
    var _hmt = _hmt || [];
    (function() {
...
<script src="{{url('index/js')}}/jquery-1.11.1.min_1.js" type="text/javascript"></script>
<script type="text/javascript">var jQuery = jQuery.noConflict();// 解决jq与prototype.js命名空间冲突的问题</script>
<script src="{{url('index/js')}}/fixed-sidebar_1.js" type="text/javascript"></script>
...
<div id="wrap">
  <div class="passport">
    <h1 class="tit_1"><img src="{{url('index/picture')}}/tit_login_1.gif" title="用户登录" alt="用户登录" />用户登录</h1>
    <!-- login -->
    <div class="login">
      ...
      <div id="tagContent">
        <div class="tagContent selectTag" id="tagContent0">
          <!--ITeye form tab-->
          <form action="/login" id="login_form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="oAjCVMoQAAao80IrZG7rj/3bkw7sz1j/EmzREq8Gygw=" /></div>            <table border="0" cellspacing="0" cellpadding="0" class="table_1">
      ...
      <div class="third">
        第三方账号登录：
        <!--<a href="/auth/google" title="Google帐号登录"><img src="{{url('index/picture')}}/google_1.png" alt="Google账号登录" /></a>-->
        <a href="/auth/weibo" title="新浪微博帐号登录"><img src="{{url('index/picture')}}/sina_1.png" alt="新浪微博账号登录" /></a>
        <!--<a href="/auth/tqq" title="腾讯微博登录"><img src="{{url('index/picture')}}/t.qq_1.png" alt="腾讯微博登录" /></a>-->
        <!--<a href="/auth/qzone" title="腾讯登录"><img src="{{url('index/picture')}}/qq_1.png" alt="腾讯账号登录" /></a>-->
      </div>
    </div>
