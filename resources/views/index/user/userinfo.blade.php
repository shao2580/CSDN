    ...
    <div class="login">
      ...
      <div id="tagContent">
        <div class="tagContent selectTag" id="tagContent0">
          <!--ITeye form tab-->
          <form action="/login" id="login_form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="0IAK2RIPTHivP+YRlAhhUSf/P10yBJZHcD2I3CNydj0=" /></div>            <table border="0" cellspacing="0" cellpadding="0" class="table_1">
