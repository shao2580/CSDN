...
<div id="wrap">
  <div class="passport">
    <h1 class="tit_1"><img src="{{url('index/picture')}}/tit_login_2.gif" title="用户登录" alt="用户登录" />用户登录</h1>
    <!-- login -->
    <div class="login">
      ...
      <div id="tagContent">
        <div class="tagContent selectTag" id="tagContent0">
          <!--ITeye form tab-->
          <form action="/login" id="login_form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="i4Wz7FLvEuIeurIbo1H0Q50jT+sGRRrUetZuiovvi1c=" /></div>            <table border="0" cellspacing="0" cellpadding="0" class="table_1">
      ...
      <div class="third">
        第三方账号登录：
        <!--<a href="/auth/google" title="Google帐号登录"><img src="{{url('index/picture')}}/google_2.png" alt="Google账号登录" /></a>-->
        <a href="/auth/weibo" title="新浪微博帐号登录"><img src="{{url('index/picture')}}/sina_2.png" alt="新浪微博账号登录" /></a>
        <!--<a href="/auth/tqq" title="腾讯微博登录"><img src="{{url('index/picture')}}/t.qq_2.png" alt="腾讯微博登录" /></a>-->
        <!--<a href="/auth/qzone" title="腾讯登录"><img src="{{url('index/picture')}}/qq_2.png" alt="腾讯账号登录" /></a>-->
      </div>
    </div>
